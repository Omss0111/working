...
export function calculateAnalysisData(
  ...
  // After calculating stdDev and withinStdDev
  if (stdDev === 0 || withinStdDev === 0) {
    throw new Error("Insufficient variation in data: all measurements are the same or only one data point is present.");
  }
